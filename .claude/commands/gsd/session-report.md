...
<execution_context>
@D:/computer-design/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @D:/computer-design/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
