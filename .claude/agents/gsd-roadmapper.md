...
Reference full template: `D:/computer-design/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/computer-design/.claude/get-shit-done/templates/state.md`.
